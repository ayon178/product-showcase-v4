    ...
    <div className="container-fluid mx-auto agency_bg p-10 py-28 flex justify-between my-8">
      <div>
        ...
        <h1 className="text-white text-xl font-medium">
          Trusted factory equipment partner <br />
          for your production system
        </h1>

        <div className="flex items-center gap-4 mt-10 w-[44%]">
          {/* First 3 items map */}
        ...
        <div className="flex items-center gap-4 mt-4 w-[70%]">
          {/* Last 3 items map */}
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-4">
          {imageData.map((image, i) => (
            <div
              key={i}
              className="bg-white rounded-lg px-7 real_shadow py-2 text-primaryText w-40 flex items-center justify-center flex-col gap-1"
            >
