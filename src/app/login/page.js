...
export default function Login() {
  ...
  return (
    <main className="login_bg relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="login_main_bg border border-slate-400 rounded-md flex items-center justify-center bg-cover bg-center">
        <div className="relative bg-white bg-opacity-10 rounded-lg p-8 w-96">
          ...
          <div className="mb-4">
            <input
              ...
              className="w-full px-4 py-2 text-primaryText rounded-lg border border-slate-400 bg-opacity-20  placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primaryText"
